...
namespace alex { namespace globals
{
    ...
    void initializeDefaults()
    {
        ...
        alex::globals::default_post_range = 125;
        alex::globals::default_secrets = {"secret"};
