...
set MIN_LOCATION_UNCERTAINTY=175
set MAX_LOCATION_UNCERTAINTY=500
set INC_LOCATION_UNCERTAINTY=25
...
set MAX_TERMS_PER_QUERY=3
set MIN_TERMS_PER_QUERY=3
...
:loop_start_num_corpus_docs
    REM set /a TOP_K=%NUM_CORPUS_DOCS%/2
