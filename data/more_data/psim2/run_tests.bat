...
set TYPES=psim
set SECRETS=secret
set RECALL_PRECISION=0
set MINDIST=1
set BM25=0
set FP_RATE=0.001

set MIN_MAX_MIN_PAIR_DIST=55
set MAX_MAX_MIN_PAIR_DIST=200
set INC_MAX_MIN_PAIR_DIST=30

set MIN_LOCATION_UNCERTAINTY=250
set MAX_LOCATION_UNCERTAINTY=250
...
set MAX_NUM_CORPUS_DOCS=250
set MIN_NUM_CORPUS_DOCS=250
set INC_NUM_CORPUS_DOCS=1

set MAX_TERMS_PER_QUERY=2
set MIN_TERMS_PER_QUERY=2
...
set /a MAX_MIN_PAIR_DIST=%MIN_MAX_MIN_PAIR_DIST%
:loop_start_max_min_pair_dist

if %MAX_MIN_PAIR_DIST% gtr %MAX_MAX_MIN_PAIR_DIST% goto loop_end_max_min_pair_dist
...
:loop_start_num_corpus_docs
	...
	echo unique: %NUM_UNIQUE_DOC_TOKENS%
            ...
            :loop_start_terms_per_query
                ...
                :loop_start_tokens_per_term
                    ...
                    :loop_start_obfuscations
                        ...
                        call run_tests_helper.bat %1\%MAX_MIN_PAIR_DIST%_%NUM_CORPUS_DOCS%_%NUM_DOC_TOKENS%_%LOCATION_UNCERTAINTY%_%TERMS_PER_QUERY%_%TOKENS_PER_TERM%_%OBFUSCATIONS%_%FP_RATE%
...
set /a MAX_MIN_PAIR_DIST+=%INC_MAX_MIN_PAIR_DIST%
goto loop_start_max_min_pair_dist

:loop_end_max_min_pair_dist
